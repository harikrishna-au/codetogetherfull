...
className="
    ...
    "
>
<div className="flex items-center gap-2 px-4 py-3 border-b border-primary/10 bg-gradient-to-r from-primary/80 to-primary/60">
...
<span className="text-accent/90">solve</span>
<span className="text-muted-foreground/60"> = </span>
<span className="text-accent">(</span>
<span className="text-accent/80">problem</span>
<span className="text-accent">)</span>
<span className="text-muted-foreground/60"> =&gt; </span>
<span className="text-accent">{"{"}</span>
</motion.div>
...
<span className="text-accent/90">collaborate</span>
<span className="text-muted-foreground/60">(</span>
<span className="text-accent/85">peers</span>
<span className="text-muted-foreground/60">, </span>
<span className="text-accent/80">problem</span>
<span className="text-muted-foreground/60">);</span>
</motion.div>
