...
// End a room / session
router.post('/end-room', asyncHandler(async (req, res) => {
...
router.get('/results/:roomId', asyncHandler(async (req, res) => {
...
router.post('/save-results', asyncHandler(async (req, res) => {
